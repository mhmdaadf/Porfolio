    ...
    <footer className='footer'>
      <div className='footer-container'>
        ...
        <div className='social-links'>
          <a href="https://github.com/mhmdaadf" target="_blank" rel='noreferrer' className='social-link' aria-label='GitHub'>
          ...
          <a href="https://wa.me/96181804493" target="_blank" rel='noreferrer' className='social-link' aria-label="WhatsApp">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="mailto:mohamad.a.alkhatib@gmail.com" className='social-link' aria-label="Email">
        ...
        <p className='copyright'>&copy; 2026 Mohammad Alkhatib. Built for performance and clarity.</p>
      </div>
    </footer>
  );
}
