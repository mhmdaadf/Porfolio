    ...
    <footer className='footer'>
      <div className='footer-container'>
        ...
        <div className='social-links'>
          <a href="https://github.com/mhmdaadf" target="_blank" className='social-link'>
          ...
          <a href="https://wa.me/96181804493" target="_blank" className='social-link' aria-label="WhatsApp">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
