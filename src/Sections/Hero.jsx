...
function Hero() {
  return (
    <header className='hero section-shell' id='home'>
      <div className='section-container hero-layout'>
        <div className='hero-content reveal'>
          ...
          <div className='hero-cta'>
            <a href='https://github.com/mhmdaadf' target='_blank' rel='noreferrer' className='cta-primary'>
              View GitHub
            </a>
          ...
          <div className='hero-social'>
            <a href='https://github.com/mhmdaadf' target='_blank' rel='noreferrer' aria-label='GitHub'>
              <img src={githubIcon} alt='GitHub' />
            </a>
            <a href='https://linkedin.com' target='_blank' rel='noreferrer' aria-label='LinkedIn'>
              <img src={linkedinIcon} alt='LinkedIn' />
            </a>
            <a href='https://wa.me/96181804493' target='_blank' rel='noreferrer' aria-label='WhatsApp'>
